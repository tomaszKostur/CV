...
\cvitem{\textbf{Rust}:} {
        \begin{itemize}
            ...
            %\item \textbf{Rocket}: Knowledge of basic concepts of framework.
        \end{itemize}
    }
...
\cventry{2018--2022}{Software developer}{Falcon V Systems}{}{}{}
\cvitem{Expertises}{
    \begin{itemize}
    \item Developing micro-services solution, powered by Docker/Kubernetes.
    \item Developing advanced test-framework. Implementation of System Under Test methodology as a collection of micro-services.
    \item Working with many Cable-Labs documents describing network protocols (L2TPv3, DOCSIS)
    \end{itemize}
}
...
%\section{Non professional achievements}
